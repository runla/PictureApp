...
import com.example.administrator.pictureapp.R;
...
public class MyGlide {
    ...
    public void loadImage(Context context, ImageView imageView,
        ...
        if (isFade) {
            Glide.with(context)
                    .load(imgUrl)
                    .crossFade()
                    .placeholder(R.mipmap.glide_place_holder)
     ...
     * @param imgUrl
     */
    public void loadGifImageAsBitmap(Context context, ImageView imageView, String imgUrl) {
        Glide.with(context)
                .load(imgUrl)
                .asBitmap()
                .priority(Priority.NORMAL) //下载的优先级
